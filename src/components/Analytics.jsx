  ...
  return (
    <main className="relative z-10 pt-20 px-4 max-w-4xl mx-auto pb-24 space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-blue-300/40 mt-1">AI-driven emotional diagnostics processed entirely in offline sandbox env.</p>
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="glass-card rounded-xl p-5 flex flex-col justify-between h-36">
          <div className="flex justify-between items-start">
            <span className="text-xs font-mono text-cyberBlue-300 uppercase tracking-widest">Total Memories</span>
            <span className="material-symbols-outlined text-cyberBlue-400">history</span>
          </div>
          <div>
        ...
        <div className="glass-card rounded-xl p-5 flex flex-col justify-between h-36">
          <div className="flex justify-between items-start">
            <span className="text-xs font-mono text-cyberBlue-300 uppercase tracking-widest">Dominant Mood</span>
            <span className="material-symbols-outlined text-cyberBlue-400">mood</span>
          </div>
          <div>
            <p className="text-3xl font-bold text-white capitalize font-sans">{dominantMood}</p>
            <p className="text-[10px] text-blue-300/40 font-mono mt-1">Based on text analysis</p>
          </div>
        </div>
        ...
        <div className="glass-card rounded-xl p-5 flex flex-col justify-between h-36">
          <div className="flex justify-between items-start">
            <span className="text-xs font-mono text-cyberBlue-300 uppercase tracking-widest">Security Health</span>
      ...
      <section className="glass-card rounded-xl p-6 space-y-5">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-xs font-mono text-blue-300/70">
      ...
      <section className="glass-card rounded-xl p-6 space-y-4">
        <div className="flex justify-between items-center">
          ...
          <span className="text-[10px] font-mono text-cyberBlue-400 uppercase tracking-widest">Cognitive Advisor</span>
        </div>

        <div className="p-4 rounded-xl border border-blue-500/10 bg-slate-950/40 text-sm text-blue-100/70 space-y-3 leading-relaxed">
          <p>
        ...
        <button 
          ...
          className="w-full py-3 bg-cyberBlue-950/40 hover:bg-cyberBlue-900/40 border border-cyberBlue-500/20 text-cyberBlue-400 hover:text-cyberBlue-300 font-semibold text-xs uppercase tracking-[0.15em] rounded-xl active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
        >
