@echo off
title YNote Release Publisher
echo.
echo =========================================================
echo               YNote GitHub Release Publisher
echo =========================================================
echo.
...
"C:\Program Files\GitHub CLI\gh.exe" release create v1.0.0 "public/app-release.apk" --title "YNote v1.0.0 - Initial Public Release" --notes-file "C:\Users\yochi\.gemini\antigravity-ide\brain\6fb83060-32de-4ab3-8b8e-eb8511d3ba27\release-notes.md"
if %errorlevel% neq 0 (
    echo.
